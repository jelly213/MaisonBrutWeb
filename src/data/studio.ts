...
export const studio: {
  ...
  body: {
    en: [
      ...
      'We work across Montreal, Laval, the North Shore and the South Shore, on private homes, restaurants and retail spaces. Most of our projects come from clients who saw a wall we finished for someone else.',
    ],
    fr: [
      ...
      "Nous intervenons à Montréal, à Laval, sur la Rive-Nord et la Rive-Sud, dans des résidences privées, des restaurants et des commerces. La plupart de nos projets viennent de clients qui ont vu un mur que nous avions fini pour quelqu'un d'autre.",
    ],
    es: [
      ...
      'Trabajamos en Montreal, Laval, la Rive-Nord y la Rive-Sud, en residencias privadas, restaurantes y locales comerciales. La mayoría de nuestros proyectos vienen de clientes que vieron un muro que terminamos para alguien más.',
    ],
  },
  ...
  facts: {
    ...
    es: [
      ...
      { label: 'Zonas atendidas', value: 'Montreal · Laval · Rive-Nord y Rive-Sud' },
