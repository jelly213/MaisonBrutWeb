...
export const faq: FaqItem[] = [
  {
    question: {
      ...
      fr: 'Quelle est la durée de vie du microciment ?',
    ...
    answer: {
      ...
      fr: "Correctement appliqué et scellé, le microciment dure aussi longtemps que son support : quinze à vingt ans est la norme dans une salle de bain résidentielle. C'est le scellant qui s'use : sur un sol très sollicité, il se renouvelle après une dizaine d'années sans refaire la finition.",
  ...
  },
  {
    ...
    answer: {
      ...
      fr: "Oui, et c'est l'une des principales raisons pour lesquelles nos clients choisissent le microciment. Tant que la céramique est saine et bien collée, nous préparons la surface, comblons les joints et appliquons par-dessus. Aucune démolition, aucun conteneur, et une salle de bain réutilisable bien plus vite.",
  ...
  },
  {
    ...
    answer: {
      ...
      fr: "Un simple mur d'accent demande généralement deux à trois jours. Une salle de bain complète en microciment prend cinq à sept jours, séchage et scellement compris. Les grands sols et les espaces commerciaux sont planifiés après la visite, et l'échéancier vous est remis par écrit avant le début des travaux.",
  ...
  },
  {
    ...
    answer: {
      ...
      fr: "Le microciment scellé avec notre système polyuréthane est imperméable et convient aux douches et pièces humides. Le plâtre vénitien et la peinture à la chaux résistent à l'eau tout en restant perspirants, ce qui est souhaitable sur un mur ; nous ne les posons pas à l'intérieur d'une douche.",
